...
export async function sendOTPEmail(email: string, otp: string, purpose: "register" | "login") {
  const subject =
    purpose === "register"
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
      ...
      <p style="color: #555; margin-bottom: 24px;">
        ${purpose === "register" ? "Thanks for signing up! Verify your Gmail to get started." : "Use this OTP to log in to your account."}
      </p>
